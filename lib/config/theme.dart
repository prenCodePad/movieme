...
class AppTheme extends DefaultTheme {
  ...
  final themeGreen = const Color(0xff44d97b);
  final themeBlue = const Color(0xff111725);
  ...
  TextStyle subTitle2({Color? color, FontStyle? fontStyle}) =>
      primary(size: 32, fontWeight: FontWeight.w400, color: color, fontStyle: fontStyle);
  @override
  TextStyle subTitle3({Color? color, FontStyle? fontStyle}) =>
      primary(size: 28, fontWeight: FontWeight.w400, color: color, fontStyle: fontStyle);
  @override
  ...
  @override
  TextStyle body({Color? color, FontStyle? fontStyle}) => primary(
        size: 16,
  ...
  @override
  TextStyle bodyBold({Color? color, FontStyle? fontStyle}) => primary(
        size: 16,
        fontWeight: FontWeight.w700,
        color: color,
        fontStyle: fontStyle,
...
abstract class DefaultTheme {
  ...
  TextStyle bodyBold({Color? color, FontStyle? fontStyle});
  TextStyle bodySmall({Color? color, FontStyle? fontStyle});
  TextStyle overline({Color? color, FontStyle? fontStyle});
  TextStyle label({Color? color, FontStyle? fontStyle});
  TextStyle label1({Color? color, FontStyle? fontStyle});
  ...
  ButtonStyle textButtonStyle({double? minHeight, Color? color}) => TextButton.styleFrom(
      foregroundColor: color ?? buttonOutlineTextColor,
